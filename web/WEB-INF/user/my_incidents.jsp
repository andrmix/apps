    ...
    <body>
        <form action='<c:url value="/user/my_incidents"/>' method="POST">
            ...
            <div id="sidebar">
                ...
                <div class="sidebar_el">
                    <a href='<c:url value="/user"/>'><div class="u_iconv"></div><span class="videl">Активные обращения
                            <c:if test="${openIncidentsNew.size() gt 0}">
                                <span class="videlc">${openIncidentsNew.size()}</span>
                            </c:if>
                        </span></a></div>
                <div class="sidebar_el">
                    <a href='<c:url value="/user/closed_incidents"/>'><div class="u_icon"></div>Закрытые обращения
