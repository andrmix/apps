...
<html>
    ...
    <body>
        <form action='<c:url value="/manager/manager_incidents"/>' method="POST">
            <div id="header">
            ...
            <div id="sidebar">
                ...
                <c:choose>
                    <c:when test="${isspec == 1}">
                        ...
                        <div id="pan_moder">
                            <p><a href='<c:url value="/manager/manager_incidents"/>'><span class="videl">Активные обращения 
                ...
                <table class="incidents_tab">
                    <thead>
                        <tr>
                            ...
                            <th><a href='<c:url value="/sort_by_zay_m_act"/>'>Заявитель</a></th>
                        </tr>
                    </thead>
                    <tbody>
