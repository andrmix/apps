    ...
    <body>
        <form action='<c:url value="/manager/new_task"/>' method="GET">
            <div id="header">
                ...
                <div class="head_block"><img class="user_pic" src='<c:url value="/img/user32.png"/>'><div class="heada">${user.name} (<a href='<c:url value="/logout"/>'>Выйти</a>)</div><div class="headb">/ Новое задание</div></div>
            </div>
            <div id="sidebar">
