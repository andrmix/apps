        ...
        <form action='<c:url value="/admin/new_depart"/>' method="POST">
            <div id="header">
                ...
                <div class="head_block"><img class="user_pic" src='<c:url value="/css/img/user.png"/>'>
                    ...
                    </div><div class="headb">/ Отделы / Новый отдел</div>
                </div>
            </div>
            <div id="sidebar">
                        ...
                        <li>
                            <c:choose>
                                <c:when test="${editDepart == 1}">
                                    <button type="submit" name="Edit" class="ibutt" onclick="return AdminDepart(this.form)"/><img class="img_butt" src='<c:url value="/css/img/done.png"/>'>Изменить</button>
                                </c:when>
                                <c:otherwise>
                                    <button type="submit" name="Add" class="ibutt" onclick="return AdminDepart(this.form)"/><img class="img_butt" src='<c:url value="/css/img/done.png"/>'>Добавить</button>
                                </c:otherwise>
                            </c:choose>
