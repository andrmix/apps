                        ...
                        <li>
                            <c:choose>
                                <c:when test="${editDepart == 1}">
                                    <input type="submit" value="Изменить" name="Edit" class="ibutt" onclick="return AdminDepart(this.form)"/>
                                </c:when>
                                <c:otherwise>
                                    <input type="submit" value="Добавить" name="Add" class="ibutt" onclick="return AdminDepart(this.form)"/>
                                </c:otherwise>
                            </c:choose>
