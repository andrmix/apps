...
<html>
    ...
    <body>
        <div id="header">
            ...
            <div class="head_block"><img class="user_pic" src='<c:url value="/img/user32.png"/>'><div class="heada">${user.name} (<a href='<c:url value="/logout"/>'>Выйти</a>)</div><div class="headb">/ Активные обращения / Данные обращения</div></div>
        </div>
        <div id="sidebar">
                    ...
                    <li>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:choose>
                                    <c:when test="${done == 1}">
                                        <textarea name="decision" cols="40" rows="3"></textarea>
