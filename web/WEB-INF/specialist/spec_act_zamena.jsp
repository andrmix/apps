...
<html>
    ...
    <body>
        <form action='<c:url value="/specialist/spec_act_zamena"/>' method="POST">
            ...
            <div class="noprint">
                <a href='<c:url value="/specialist/spec_incident_data?id=${inc_id}"/>'><div class="abutt"><img class="img_butt" src='<c:url value="/css/img/nazad_w_b.png"/>'>Назад</div></a>
                <a onclick="print()"><div class="abutt"><img class="img_butt" src='<c:url value="/css/img/zamena.png"/>'>Печать</div></a>
